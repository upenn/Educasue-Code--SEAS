import pandas as pd
import requests
from Canvas_API.SEAS_Canvas import Canvas
import json
...
def load_json():
    with open("/Users/minghaotao/Desktop/GS_Late/Canvas_API/slack_cred.json", 'r') as f:
        cred = json.load(f)
        return cred
...
def slack_bot(message=None, type=None):
    ...
    if type == 'file':
        bot.files.upload(channels=channel,
                         file_=f'/Users/minghaotao/Desktop/GS_Late/late_files/late_submissions.csv')
...
def access_files():
    df = pd.read_csv("/Users/minghaotao/Desktop/GS_Late/late_files/late_submissions.csv")
